...
LOCAL_MODULE := SDL2_sound_static

LOCAL_C_INCLUDES := $(LOCAL_PATH)  $(LOCAL_PATH)/include $(LOCAL_PATH)/decoders $(LOCAL_PATH)/decoders/libmpg123 $(LOCAL_PATH)/../vorbis-include
LOCAL_CFLAGS := -O3 -DHAVE_CONFIG_H -DREAL_IS_FLOAT -DOPT_GENERIC -DMPG123_NO_CONFIGURE -DSOUND_SUPPORTS_MPG123 -DSOUND_SUPPORTS_OGG
